...
public class SlidingActivity extends Activity implements SlidingActivityBase {
	...
	/* (non-Javadoc)
	 * @see android.app.Activity#setContentView(android.com.hy.news.view.View)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see android.app.Activity#setContentView(android.com.hy.news.view.View, android.com.hy.news.view.ViewGroup.LayoutParams)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.jeremyfeinstein.slidingmenu.lib.app.SlidingActivityBase#setBehindContentView(android.com.hy.news.view.View)
	 */
	...
	/* (non-Javadoc)
	 * @see com.jeremyfeinstein.slidingmenu.lib.app.SlidingActivityBase#setBehindContentView(android.com.hy.news.view.View, android.com.hy.news.view.ViewGroup.LayoutParams)
	 */
	...
	/* (non-Javadoc)
	 * @see android.app.Activity#onKeyUp(int, android.com.hy.news.view.KeyEvent)
	 */
	@Override
