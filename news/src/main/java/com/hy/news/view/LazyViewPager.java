 ...
 * {@link PagerAdapter} to generate the pages that the com.hy.news.view shows.
 *
...
public class LazyViewPager extends ViewGroup {
     ...
     * is fully in com.hy.news.view and no animation is in progress.
     */
...
//            mAdapter.registerDataSetObserver(mObserver);
    ...
    void setCurrentItemInternal(int item, boolean smoothScroll, boolean always, int velocity) {
        ...
        if (item > (mCurItem + pageLimit) || item < (mCurItem - pageLimit)) {
            ...
            // glitches, we want to keep all current pages in the com.hy.news.view
     ...
     * current page in the com.hy.news.view hierarchy in an idle state. Defaults to 1.
     *
     ...
     * current page in the com.hy.news.view hierarchy in an idle state. Pages beyond this
     ...
     * newly created com.hy.news.view subtrees as the user pages back and forth.</p>
     *
    ...
    void populate() {
        ...
        // avoid trying to populate before we have restored our com.hy.news.view hierarchy
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        // our com.hy.news.view.  We can't really know what it is since we will be
    ...
    private void completeScroll() {
        ...
        if (needPopulate) {
            // Done with scroll, no longer want to cache com.hy.news.view drawing.
            setScrollingCacheEnabled(false);
            ...
            case MotionEvent.ACTION_MOVE: {
                ...
                */
                ...
                if (canScroll(this, false, (int) dx, (int) x, (int) y)) {
                    // Nested com.hy.news.view has scrollable area under this point. Let it be handled there.
     ...
     * with the touch scrolling of another com.hy.news.view, while still letting the ViewPager
     ...
     * @param checkV Whether the com.hy.news.view v passed should itself be checked for scrollability (true),
    ...
    public boolean dispatchKeyEvent(KeyEvent event) {
        // Let the focused com.hy.news.view and/or our descendants get the key first
        return super.dispatchKeyEvent(event) || executeKeyEvent(event);
    }

    /**
     * You can call this function yourself to have the scroll com.hy.news.view perform
     * scrolling from a key event, just as if the event had been dispatched to
     * it by the com.hy.news.view hierarchy.
     *
